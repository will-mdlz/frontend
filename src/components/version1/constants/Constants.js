...
export const ROW_LABELS = ["Volume", "Vol PY%", "Price/Vol", "Price PY%", "Revenue", "Rev PY%", "COGS", "COGS/VOL", "COGS/VOL PY%", "Gross Profit", "GP Margin", "A&C", "A&C Margin", "Distribution", "Distribution Margin", "Ovh", "Ovh Margin",
  "OIE", "OIE Margin", "EBIT", "EBIT Margin", "Depreciation/Amortization", "D&A Margin", "EBITDA", "EBITDA Margin", "Non-Service Pension", "Taxes",
...
export const SECTIONS = ["Volume", "Vol PY%", "Price/Vol", "Price PY%", "Revenue", "Rev PY%", "COGS", "COGS/VOL", "COGS/VOL PY%", "Gross Profit", "GP Margin", "A&C", "A&C Margin", "Distribution", "Distribution Margin"];
export const SECTIONS_PERC = [1, 3, 5, 8, 10, 12, 14]
...
for(let i = 0; i < ROW_LABELS.length; i++) {
  row_dict[ROW_LABELS[i]] = i;
};

export const rowDict = row_dict;
...
export const SHEETS = ['Stand Alone', 'Revenue Synergies', 'Cost Synergies', 'P&L Synergies'];