...
const CostTemplate = ({segKey, handleDataChanged}) => {
  ...
  const total_years = dataManagerInstance.rawdata["COST"][segKey][0].length;
  const COLUMN_LABELS = generateColumnLabels(dataManagerInstance.input["COST"][segKey]['startingyear'], total_years);
